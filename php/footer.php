...
<head>
  ...
  <link rel="stylesheet" href="../css/php/footer.css">
  <body>
  <footer class="bg-dark text-white text-center py-4 mt-auto shadow">
  <div class="container">
    <div class="mb-3">
    ...
    <p class="mb-0">&copy; 2025 JJ TECH SOLUTIONS. All rights reserved.</p>
  </div>
</footer>
</body>
</html>
<nav class="navbar navbar-expand-lg navbar-custom fixed-top shadow">
  <div class="container">
    <a class="navbar-brand fw-bold" href="index.html">JJ TECH SOLUTIONS</a>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown custom-dropdown">
          ...
          <div class="dropdown-menu shadow-lg p-4" aria-labelledby="productsDropdown">
            ...
            <a class="dropdown-item" href="#">Intventory</a>
            <a class="dropdown-item" href="#">Breeder</a>
            <a class="dropdown-item" href="#">Hatcher</a>
